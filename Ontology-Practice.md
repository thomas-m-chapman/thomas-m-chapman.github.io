...
## Acknowledgements
I’d like to thank Jessica Talisman for introducing me to the Ontology Pipeline and the role that each component of the pipeline plays in improving the trustworthiness of AI output.

I’d also like to thank Michael Iantosca for his seminal work in agentic AI, for so clearly articulating the need for structured, semantically rich content in AI workflows, and for emphasizing the value that technical writers/knowledge managers (cum content engineers/knowledge engineers) bring to this exciting new arena.
