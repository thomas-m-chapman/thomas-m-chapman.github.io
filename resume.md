...
- Content Strategy
- DITA, HTML/CSS, Information Architecture
- Markdown
- Minimalism
...
- Led Isilon’s KM strategy, including three knowledge base migrations, to enhance customer self-service and reduce calls to Support.
- Collaborated with Support to devise troubleshooting guides that reduced Time to Resolve (TTR) by 44%. 
...
- Spearheaded the launch of Isilon’s first customer-facing knowledge base and integrated Knowledge-Centered Service (KCS) methodologies into KM and Support workflows.
...
- Created OEM content for SAN administrators; coordinated translation activities. 
...
- Edited proposals, manuals, and marketing collateral to improve clarity and effectiveness.
...
- Led an 8-person team; pioneered a structured-authoring project that increased CSAT by 65%. 
...
- Developed user guides for student loan administration software.
